defmodule Thriveaidv2Web.CoreComponents do
  @moduledoc """
  ...
  use Gettext, backend: Thriveaidv2Web.Gettext
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(Thriveaidv2Web.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(Thriveaidv2Web.Gettext, "errors", msg, opts)
    end
  end
