...
config :thriveaidv2, Thriveaidv2Web.Endpoint,
  ...
  render_errors: [
    formats: [html: Thriveaidv2Web.ErrorHTML, json: Thriveaidv2Web.ErrorJSON],
    layout: false
  ],
  pubsub_server: Thriveaidv2.PubSub,
  live_view: [signing_salt: "fJP12ezn"]
